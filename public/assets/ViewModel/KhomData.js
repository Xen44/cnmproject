function viewModel() {
    ...
    app.ajax('/admin/khom-data/getdata').done(function (rs) {
        place = rs.place;
    ...
    self.showEdit = function (master) {
        ...
        if (master.id() == 0) {
            ...
            app.ajax('/admin/khom-data/getdetail', submit).done(function (rs) {
                self.masterModel(master);
    ...
    self.save = function () {
        ...
        app.ajax('/admin/khom-data/save', submit).done(function (model) {
            if (master.id == 0) {
    ...
    self.showDelete = function (model) {
        ...
        app.ajax('/admin/khom-data/delete', submit).done(function () {
