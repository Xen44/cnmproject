...
use App\Http\Controllers\Admin\KhomDataController;
...
Route::group(['middleware' => 'auth'], function () {
    Route::group(
        ['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
            ...
            Route::any('/khom-data', [KhomDataController::class, 'index'])->name('khom-data');
            Route::any('/khom-data/getdata', [KhomDataController::class, 'getdata']);
            Route::any('/khom-data/getdetail', [KhomDataController::class, 'getdetail']);
            Route::post('/khom-data/save', [KhomDataController::class, 'save']);
            Route::post('/khom-data/delete', [KhomDataController::class, 'delete']);
